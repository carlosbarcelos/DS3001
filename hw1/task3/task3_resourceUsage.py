...
# = Part 1 - Resource Usage Only
df = csv.drop(columns=['Department', 'Department Name', 'Property Id', 'Address 1', 'City', 'State/Province',
...
ans_1_1 = sk.pairwise_distances(df.drop(columns=['Property Name']), metric='euclidean')[index]
...
print('Euclidean Distance yields these as the most similar properties :\n' +
      df['Property Name'][ans_1_1_sorted[1][0]] + '\n' +
      df['Property Name'][ans_1_1_sorted[2][0]] + '\n' +
      df['Property Name'][ans_1_1_sorted[3][0]] + '\n')

# == 1.2 - Manhattan Distance
# Find the Manhattan Distance for the desired property
ans_1_2 = sk.pairwise_distances(df.drop(columns=['Property Name']), metric='manhattan')[index]
# Sort the results making sure to capture the original Property Name and position
...
print('Manhattan Distance yields these as the most similar properties :\n' +
      df['Property Name'][ans_1_2_sorted[1][0]] + '\n' +
      df['Property Name'][ans_1_2_sorted[2][0]] + '\n' +
      df['Property Name'][ans_1_2_sorted[3][0]] + '\n')

# == 1.3 - Cosine Similarity
# Find the cosine similarity for the desired property
ans_1_3 = sk.pairwise_distances(df.drop(columns=['Property Name']), metric='cosine')[index]
# Sort the results making sure to capture the original Property Name and position
...
print('Cosine Similarity yields these as the most similar properties :\n' +
      df['Property Name'][ans_1_3_sorted[1][0]] + '\n' +
      df['Property Name'][ans_1_3_sorted[2][0]] + '\n' +
      df['Property Name'][ans_1_3_sorted[3][0]] + '\n')
